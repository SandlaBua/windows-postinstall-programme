...
$packages = @(
    ...
    @{ Id = 'RockstarGames.Launcher';        Scope = 'machine'; PreKill = @('rockstargameslauncher', 'launcherpatcher') }
    @{ Id = 'MedalB.V.Medal';                Scope = 'user';    PreKill = @('medal') }
    @{ Id = 'Vendicated.Vencord';            Scope = 'user';    PreKill = @('discord', 'vencordinstaller') }
)

$ui = Show-StatusWindow -Title 'Gaming & Launcher' -InitialText 'Starte Installation...'
